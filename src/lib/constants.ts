...
export const STYLE_PREMIA_CONFIG = {
  value: {
    ...
    operators: ['rank', 'zscore', 'ts_mean', 'ts_delta', 'ts_decay_linear', 'winsorize', 'ts_zscore'],
    description: 'Cash-flow efficiency, earnings quality, balance sheet strength',
  },
  momentum: {
    label: 'Momentum',
    datasets: ['pv13', 'news12'],
    operators: ['ts_rank', 'ts_delta', 'ts_returns', 'ts_ir', 'ts_zscore', 'signed_power', 'ts_av_diff'],
    description: 'Price momentum, earnings momentum, trend persistence',
  },
  carry: {
    label: 'Carry',
    datasets: ['fundamental6', 'analyst4'],
    operators: ['group_rank', 'group_mean', 'ts_zscore', 'ts_delay', 'if_else', 'rank', 'ts_delta'],
    description: 'Dividend yield, earnings yield, funding differentials',
  },
  defensive: {
    label: 'Defensive',
    datasets: ['fundamental6', 'model16'],
    operators: ['ts_std_dev', 'ts_skewness', 'ts_min', 'rank', 'winsorize', 'ts_zscore', 'ts_mean'],
    description: 'Low volatility, high quality, downside protection',
  },
  sentiment: {
    label: 'Sentiment',
    datasets: ['news12', 'analyst4'],
    operators: ['ts_rank', 'ts_delta', 'signed_power', 'sigmoid', 'ts_zscore', 'vec_avg', 'vec_count'],
    description: 'News sentiment, analyst revisions, social signals',
  },
  volatility: {
    label: 'Volatility',
    datasets: ['pv13', 'model16'],
    operators: ['ts_std_dev', 'ts_kurtosis', 'ts_entropy', 'ts_moment', 'ts_zscore', 'ts_regression', 'rank'],
    description: 'Volatility regime, dispersion, tail risk signals',
  },
  quality: {
    label: 'Quality',
    datasets: ['fundamental6', 'model51'],
    operators: ['ts_mean', 'ts_rank', 'rank', 'group_rank', 'winsorize', 'group_neutralize', 'scale'],
